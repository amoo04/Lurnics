...
const STATUS_META: Record<string, { label: string; dotColor: string }> = {
  discovery: { label: "Discovery", dotColor: "bg-indigo-400" },
  development: { label: "Development", dotColor: "bg-blue-400" },
  testing: { label: "Testing", dotColor: "bg-orange-400" },
        ...
        return (
          <div key={status} className="w-64 shrink-0">
            ...
            <div className="space-y-3">
                ...
                <div key={project.id} className="rounded-lg border border-white/10 bg-white/[0.03] p-3">
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <div className="h-1.5 flex-1 overflow-hidden rounded-full bg-white/10">
                      <div className="h-full rounded-full bg-indigo-400" style={{ width: `${project.progress}%` }} />
                    </div>
                  ...
                  <div className="mt-3 flex items-center justify-between gap-2 text-xs text-gray-500">
                    ...
                    <select
                      ...
                      className="rounded border border-white/10 bg-[#0b0f1a] px-1.5 py-1 text-[11px] text-gray-300 outline-none"
                    >
              ...
              {cards.length === 0 && <p className="text-xs text-gray-600">No projects</p>}
            </div>
          </div>
        );
      })}
