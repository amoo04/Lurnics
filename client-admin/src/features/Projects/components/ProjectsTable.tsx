  ...
  return (
    <div className="rounded-xl border border-white/10 bg-white/[0.03] p-6">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 rounded-md border border-white/10 bg-white/[0.02] px-3 py-1.5 text-sm text-gray-400">
          <Search size={14} />
          <input
            type="text"
            value={search}
            ...
            <tbody>
              {projects.map((p) => (
                <tr key={p.id} className="border-b border-white/5">
                  ...
                  <td className="py-3">
                    <span className="rounded-full bg-indigo-500/20 px-2.5 py-1 text-xs capitalize text-indigo-300">
                      {p.status}
                    </span>
                  </td>
                  <td className="py-3">
                  ...
                  <td className="py-3 text-gray-400">{p.budget != null ? formatCurrency(p.budget) : "—"}</td>
