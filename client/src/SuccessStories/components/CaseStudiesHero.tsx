  ...
  return (
    <section className="grid items-center gap-12 px-4 sm:px-8 md:px-20 py-16 md:grid-cols-2">
      <div>
        ...
        <h1 className="mt-4 text-3xl font-bold leading-tight text-gray-900 sm:text-4xl md:text-6xl">
          Real results.
          <br />
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
          <Link
            to="/case-studies"
            className="flex items-center justify-center gap-2 rounded-md bg-gray-900 px-7 py-3.5 text-base font-medium text-white hover:bg-black"
          >
