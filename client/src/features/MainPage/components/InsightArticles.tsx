    ...
    <section className="px-4 sm:px-8 md:px-20 pb-16">
      ...
      {featured && (
        <Link
          ...
          className="grid gap-6 rounded-xl border border-gray-200 bg-white p-2 shadow-sm md:grid-cols-2"
        >
          <div className="relative flex h-56 items-center justify-center rounded-lg bg-gray-50 text-gray-400 md:h-full">
          ...
          <div className="p-6">
            <h3 className="mt-2 text-2xl font-semibold text-gray-900">{featured.title}</h3>
            {featured.excerpt && <p className="mt-3 text-sm text-gray-600">{featured.excerpt}</p>}
          ...
          {rest.map(({ id, slug, title, excerpt, publishedAt }) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                {excerpt && <p className="mt-2 text-xs text-gray-600">{excerpt}</p>}
