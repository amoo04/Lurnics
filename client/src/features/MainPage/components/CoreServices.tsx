  ...
  return (
    <section className="px-4 sm:px-8 md:px-20 py-16">
      <div className="mb-12 text-center">
        ...
        <h2 className="mt-2 text-3xl font-semibold text-gray-900">Our Core Services</h2>
        ...
        {services.map(({ icon: Icon, iconBg, title, description, items }) => (
          ...
          >
            ...
            <Link
              ...
              className="mt-6 flex h-9 w-9 items-center justify-center self-end rounded-full border border-gray-200 bg-gray-50 text-gray-900"
            >
              <ArrowRight size={16} />
            </Link>
          </div>
